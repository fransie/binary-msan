...
SANITIZER_INTERFACE_ATTRIBUTE struct SymbolizedStack {
...
SANITIZER_INTERFACE_ATTRIBUTE class Symbolizer final {
 public:
  ...
  SANITIZER_INTERFACE_ATTRIBUTE bool GetModuleNameAndOffsetForPC(uptr pc, const char **module_name,
                                   uptr *module_address);
